...
def start_loophole():
    loophole_path = r"C:/Users/User/loophole.exe"
    # Updated command to start Loophole with the correct syntax
    loophole_command = [loophole_path, "http", "5000", "--hostname", "gruhrakshak"]
...
def plot_mq6():
    ...
    try:
        ...
        timestamps_mq6 = [row[0].astimezone(ist) for row in data]
...
def plot_aht21():
    ...
    try:
        ...
        timestamps_temperature = [row[0].astimezone(ist) for row in temperature_data]
        temperatures = [row[1] for row in temperature_data]

        timestamps_humidity = [row[0].astimezone(ist) for row in humidity_data]
...
def overall():
    ...
    try:
        ...
        timestamps_mq6 = [row[0].astimezone(ist) for row in mq6_data]
